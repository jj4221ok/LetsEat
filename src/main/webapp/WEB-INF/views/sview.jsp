...
<body>
	...
	<input type="hidden" value="${sessionScope.cloginCode}" id="cCode">
...
<script>
	function storemodify(){
		...
		output +="<form action='sModify' method='POST' encType='multipart/form-data'>";
		output +="	<table>					";
		...
		output +="			<input type='hidden' value='${sessionScope.cloginCode}' name='scCode'>			";
                ...
                if (confirm('해당 업체를 삭제하시겠습니까?')==true) {
                   ...
                   $.ajax({
                     ...
                     success : function(data){
                        if(data=="OK"){
                        alert('삭제되었습니다.');
                        location.href="mgstore?scCode=" + cCode;
                        }
                     },//end sucess
