...
<%-- <c:if test="${empty bookDate}"><!--날짜선택 안할시 현재날짜 --> --%>
	...
	<input type="hidden" value="${storeCode}" name="booksCode">
	불러온 mngbook이 비어있으면 여기로 ${bookDate}
		<table>
			<tr>
				<th>시간</th>
				<th>현재 예약 수</th>
	...
	<input type="hidden" value="${bookDate}" name="bookDate">
	<input type="hidden" value="${storeCode}" name="booksCode">
	불러온 mngbook에 뭔가 있으면 update changemngbook 여기로 (bookDate:  ${bookDate} )
		<table>
			<tr>
				<th>시간</th>
				<th>현재 예약 수</th>
	...
	<div id="dialog" title="예약가능 건수 기본 설정하기">
	...
	<button onclick="location.href='index'">목록보기</button>
